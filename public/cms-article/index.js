...
var CmsArticle = Vue.component('cms-article', function(resolve) {
	$.get("/cms-article/index.html",
		function(htmlStr) {
			cmsArticleConfig.template = htmlStr;
			resolve(cmsArticleConfig);
		}
	);
});
